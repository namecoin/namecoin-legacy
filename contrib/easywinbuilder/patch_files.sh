...
# winsock trouble
sed -i.bak 's/DEFS=-DWIN32 /DEFS=-DWIN32_LEAN_AND_MEAN /g' $ROOTPATHSH/src/makefile.mingw
sed -i.bak 's/DEFINES += WIN32$/DEFINES += WIN32_LEAN_AND_MEAN/g' $ROOTPATHSH/${COINNAME}-qt.pro
